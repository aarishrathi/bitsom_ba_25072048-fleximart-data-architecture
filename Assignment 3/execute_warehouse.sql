-- Combined script to create and populate the FlexiMart Data Warehouse
-- Execute with: mysql -u <username> -p < execute_warehouse.sql
-- Or: mysql -u <username> -p fleximart_dw < execute_warehouse.sql
